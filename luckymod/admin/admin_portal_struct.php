...
switch ( $mode )
{
	...
	break;
	case 'createsave'	:
		$sql = "INSERT INTO " . PORTAL_PAGE . "(page_desc, page_defaultsize, page_col1width, page_col1unit, page_col2width, page_col2unit, page_col3width, page_col3unit )
		  VALUES('" . addslashes($page_desc) . "', '$page_defaultsize', '$page_col1width', '$page_col1unit', '$page_col2width', '$page_col2unit', '$page_col3width', '$page_col3unit' )" ;
		if(!$db->sql_query($sql))
		{
			message_die(GENERAL_ERROR, "Could not update portal page table!", "", __LINE__, __FILE__, $sql);
		}
	...
	break;
	case 'editsave' :
		$sql = "UPDATE " . PORTAL_PAGE . " SET page_desc='" . addslashes($page_desc) . "', page_defaultsize='$page_defaultsize', page_col1width='$page_col1width', page_col1unit='$page_col1unit',
