...
elseif( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'right' )
{
	...
	$sql = "SELECT u.user_id, u.username, u.user_session_time, u.user_session_page, s.session_logged_in, s.session_ip, s.session_start 
		...
		//-- mod : totally erc ---------------------------------------------------------
//-- add
	$sql = str_replace('SELECT ', 'SELECT u.user_allow_viewonline, u.user_level, u.user_whosonline_color, ', $sql);
//-- fin mod : totally erc -----------------------------------------------------		
	if(!$result = $db->sql_query($sql))
	{
...
MOD-*/
//-- add
				$style = $erc->get_colors($onlinerow_reg[$i]);
