...
switch( $mode )
{
	...
	case "edit":
		...
		if( $submit )
		{
			...
			//-- mod : totally erc ---------------------------------------------------------
//-- add
			$updated['erc_admincolor'] = $HTTP_POST_VARS['erc_admincolor'];
			$updated['erc_modcolor'] = $HTTP_POST_VARS['erc_modcolor'];
			$updated['erc_usercolor'] = $HTTP_POST_VARS['erc_usercolor'];
//-- fin mod : totally erc -----------------------------------------------------
		...
		else
		{
			...
			$template->assign_vars(array(
				...
				//-- mod : totally erc ---------------------------------------------------------
//-- add
				"L_ERC_SETTINGS" => $lang['erc_settings'],
				"L_ERC_ADMINCOLOR" => $lang['erc_admincolor'],
				"L_ERC_MODCOLOR" => $lang['erc_modcolor'],
				"L_ERC_USERCOLOR" => $lang['erc_usercolor'],

				"ERC_ADMINCOLOR" => $selected['erc_admincolor'],
				"ERC_MODCOLOR" => $selected['erc_modcolor'],
				"ERC_USERCOLOR" => $selected['erc_usercolor'],
//-- fin mod : totally erc -----------------------------------------------------
