...
else
{
	while( $row = $db->sql_fetchrow($result) )
	{
		...
		//-- mod : totally erc ---------------------------------------------------------
//-- add
		if (isset($HTTP_POST_VARS['allow_totally_erc']) && empty($HTTP_POST_VARS['allow_totally_erc']) && $board_config['cache_erc'])
		{
			$new['cache_erc'] = intval($HTTP_POST_VARS['allow_totally_erc']);
		}
//-- fin mod : totally erc -----------------------------------------------------
...
//-- mod : totally erc ---------------------------------------------------------
//-- add
$allow_totally_erc_yes = ($new['allow_totally_erc']) ? 'checked="checked"' : '';
$allow_totally_erc_no = (!$new['allow_totally_erc']) ? 'checked="checked"' : '';
$group_admin_erc_yes = ($new['group_admin_erc']) ? 'checked="checked"' : '';
$group_admin_erc_no = (!$new['group_admin_erc']) ? 'checked="checked"' : '';
$group_mod_erc_yes = ($new['group_mod_erc']) ? 'checked="checked"' : '';
$group_mod_erc_no = (!$new['group_mod_erc']) ? 'checked="checked"' : '';

if ($board_config['allow_totally_erc'])
{
	$cache_erc_yes = ($new['cache_erc']) ? 'checked="checked"' : '';
	$cache_erc_no = (!$new['cache_erc']) ? 'checked="checked"' : '';
}
//-- fin mod : totally erc -----------------------------------------------------
...
$new['reason'] = str_replace('"', '&quot;', $new['reason']);
...
// End add - Last visit MOD
	...
	//-- mod : totally erc ---------------------------------------------------------
//-- add
	"L_ALLOW_TOTALLY_ERC_SETTINGS" => $lang['Allow_totally_erc_settings'],
	"L_ALLOW_TOTALLY_ERC" => $lang['Allow_totally_erc'],
	"L_GROUP_ADMINMOD_ERC" => $lang['Group_adminmod_erc'],
	"L_GROUP_ADMIN_ERC" => $lang['Group_admin_erc'],
	"L_GROUP_MOD_ERC" => $lang['Group_mod_erc'],
//-- fin mod : totally erc -----------------------------------------------------
...
// End add - Last visit MOD
	...
	//-- mod : totally erc ---------------------------------------------------------
//-- add
	"ALLOW_TOTALLY_ERC_YES" => $allow_totally_erc_yes,
	"ALLOW_TOTALLY_ERC_NO" => $allow_totally_erc_no,
	"GROUP_ADMIN_ERC_YES" => $group_admin_erc_yes,
	"GROUP_ADMIN_ERC_NO" => $group_admin_erc_no,
	"GROUP_MOD_ERC_YES" => $group_mod_erc_yes,
	"GROUP_MOD_ERC_NO" => $group_mod_erc_no,
//-- fin mod : totally erc -----------------------------------------------------
...
if ($board_config['allow_totally_erc'])
{
	$template->assign_block_vars('erc', array(
		'L_CACHE_ERC' => $lang['Cache_erc'],
		'CACHE_ERC_YES' => $cache_erc_yes,
		'CACHE_ERC_NO' => $cache_erc_no,
	));
}
//-- fin mod : totally erc -----------------------------------------------------
