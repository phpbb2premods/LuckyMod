...
<!-- BEGIN custom_block -->
	...
	<tr>
		...
		<td class="row2"><center>
                <A HREF ="../editeur/editeur.html" TARGET="popup" onclick="window.open('','popup','width=800,height=500,left=100,top=50,resizable=no,scrollbars=no,toolbar=no,menubar=no,location=no,status=no')"
>Editeur html pour la mise en forme de votre bloc</A><br><br></center>
