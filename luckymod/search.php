...
MOD-*/
//-- add
				$style_color = $erc->get_colors($searchset[$i]);
...
MOD-*/
//-- add
				$topic_author_color = $erc->get_colors($searchset[$i]);
...
MOD-*/
//-- add
				$last_post_author_color = $erc->get_colors($searchset[$i], '', false, 'id2', 'erc_color2', 'level2');
