...
else if ( $mode == 'read' )
{
	...
	$sql = "SELECT u.username AS username_1, u.user_id AS user_id_1, u2.username AS username_2, u2.user_id AS user_id_2, u.user_sig_bbcode_uid, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_sig, u.user_avatar, pm.*, pmt.privmsgs_bbcode_uid, pmt.privmsgs_text
		...
		WHERE pm.privmsgs_id = $privmsgs_id
			...
			//-- mod : totally erc ---------------------------------------------------------
//-- add
	$sql = str_replace(', u.user_id AS user_id_1', ', u.user_id AS user_id_1, u.user_level AS user_level_1, u.user_whosonline_color AS user_whosonline_color_1', $sql);
	$sql = str_replace(', u2.user_id AS user_id_2', ', u2.user_id AS user_id_2, u2.user_level AS user_level_2, u2.user_whosonline_color AS user_whosonline_color_2', $sql);
//-- fin mod : totally erc -----------------------------------------------------			
...
/*-MOD
			'FROM' => $msg_username,
MOD-*/
			'FROM' => $erc->get_colors($row, $row['username']),
//-- fin mod : totally erc -----------------------------------------------------
			'SUBJECT' => $msg_subject,
			'DATE' => $msg_date,
