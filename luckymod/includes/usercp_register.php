...
$username = ( !empty($HTTP_POST_VARS['username']) ) ? phpbb_clean_username($HTTP_POST_VARS['username']) : '';
	...
	$miniland = ( isset($HTTP_POST_VARS['miniland']) ) ? intval ($HTTP_POST_VARS['miniland']) : 0;
	// Start add - Mood MOD
	$mood = ( isset($HTTP_POST_VARS['mood']) ) ? intval ($HTTP_POST_VARS['mood']) : 0;
	// End add - Mood MOD
...
// End add - Birthday MOD
	...
	//début allow_pm_arcade
$pmarcade =  ( isset($HTTP_POST_VARS['pmarcade']) ) ? ( ($HTTP_POST_VARS['pmarcade']) ? TRUE : 0 ) : TRUE;
//fin allow_pm_arcade
...
// We remove all stored login keys since the password has been updated
		...
		else
		{
			...
			// Get current date
			//
			$sql = "INSERT INTO " . USERS_TABLE . "	(user_id, username, user_regdate, user_password, user_email, user_icq, user_website, user_occ, user_from, user_interests, user_sig, user_sig_bbcode_uid, user_avatar, user_avatar_type, user_viewemail, user_aim, user_yim, user_msnm, user_attachsig, user_allowsmile, user_allowhtml, user_allowbbcode, user_allow_viewonline, user_pmarcade, user_notify, user_notify_pm, user_popup_pm, user_timezone, user_dateformat, user_lang, user_style, user_miniland, user_mood, user_gender, user_level, user_allow_pm, user_birthday, user_next_birthday_greeting, user_active, user_actkey)
				VALUES ($user_id, '" . str_replace("\'", "''", $username) . "', " . time() . ", '" . str_replace("\'", "''", $new_password) . "', '" . str_replace("\'", "''", $email) . "', '" . str_replace("\'", "''", $icq) . "', '" . str_replace("\'", "''", $website) . "', '" . str_replace("\'", "''", $occupation) . "', '" . str_replace("\'", "''", $location) . "', '" . str_replace("\'", "''", $interests) . "', '" . str_replace("\'", "''", $signature) . "', '$signature_bbcode_uid', $avatar_sql, $viewemail, '" . str_replace("\'", "''", str_replace(' ', '+', $aim)) . "', '" . str_replace("\'", "''", $yim) . "', '" . str_replace("\'", "''", $msn) . "', $attachsig, $allowsmilies, $allowhtml, $allowbbcode, $allowviewonline, $pmarcade, $notifyreply, $notifypm, $popup_pm, $user_timezone, '" . str_replace("\'", "''", $user_dateformat) . "', '" . str_replace("\'", "''", $user_lang) . "', $user_style, '$miniland', '$mood', '$gender', 0, 1, '$birthday', '$next_birthday_greeting', ";
...
else if ( $mode == 'editprofile' && !isset($HTTP_POST_VARS['avatargallery']) && !isset($HTTP_POST_VARS['submitavatar']) && !isset($HTTP_POST_VARS['cancelavatar']) )
{
	...
	$miniland=$userdata['user_miniland']; 
		// Start add - Mood MOD
	$mood=$userdata['user_mood']; 
	// End add - Mood MOD
// Start add - Gender MOD
...
//début allow_pm_arcade
	$pmarcade = $userdata['user_pmarcade'];
//fin allow_pm_arcade
...
if( isset($HTTP_POST_VARS['avatargallery']) && !$error )
{
	...
	display_avatar_gallery($mode, $avatar_category, $user_id, $email, $current_email, $coppa, $username, $email, $new_password, $cur_password, $password_confirm, $icq, $aim, $msn, $yim, $website, $location, $occupation, $interests, $signature, $viewemail, $notifypm, $popup_pm, $notifyreply, $attachsig, $allowhtml, $allowbbcode, $allowsmilies, $allowviewonline, $pmarcade, $user_style, $user_lang, $user_timezone, $user_dateformat, $userdata['session_id'], $birthday, $gender, $mood, $miniland);
}
else
{
...
switch ($miniland) 
{ 
   case 1: $miniland_be_checked="checked=\"checked\"";break; 
   case 2: $miniland_fr_checked="checked=\"checked\"";break; 
   case 3: $miniland_ca_checked="checked=\"checked\"";break;  
   case 4: $miniland_ch_checked="checked=\"checked\"";break; 
   case 5: $miniland_lu_checked="checked=\"checked\"";break; 
   
}
// Start add - Mood MOD
	switch ($mood) 
	{ 
		case 1: $mood_sad_checked="checked=\"checked\"";break; 
		case 2: $mood_happy_checked="checked=\"checked\"";break; 
		case 3: $mood_angry_checked="checked=\"checked\"";break; 
		case 4: $mood_cool_checked="checked=\"checked\"";break; 
		case 5: $mood_devil_checked="checked=\"checked\"";break; 
		case 6: $mood_ill_checked="checked=\"checked\"";break; 
		case 7: $mood_love_checked="checked=\"checked\"";break; 
		case 8: $mood_sleep_checked="checked=\"checked\"";break; 
		case 9: $mood_surprised_checked="checked=\"checked\"";break; 
	}
	// End add - Mood MOD
// Start add - Gender MOD
switch ($gender) 
...
// Start add - Mood MOD
		'MOOD' => $mood, 
		'MOOD_NO_SPECIFY_CHECKED' => $mood_no_specify_checked, 
		'MOOD_SAD_CHECKED' => $mood_sad_checked, 
		'MOOD_HAPPY_CHECKED' => $mood_happy_checked, 
		'MOOD_ANGRY_CHECKED' => $mood_angry_checked, 
		'MOOD_COOL_CHECKED' => $mood_cool_checked, 
		'MOOD_DEVIL_CHECKED' => $mood_devil_checked, 
		'MOOD_ILL_CHECKED' => $mood_ill_checked, 
		'MOOD_LOVE_CHECKED' => $mood_love_checked, 
		'MOOD_SLEEP_CHECKED' => $mood_sleep_checked, 
		'MOOD_SURPRISED_CHECKED' => $mood_surprised_checked, 
		// End add - Mood MOD
		'VIEW_EMAIL_YES' => ( $viewemail ) ? 'checked="checked"' : '',
		'MINILAND' => $miniland, 
'MINILAND_NO_SPECIFY_CHECKED' => $miniland_no_specify_checked, 
'MINILAND_BE_CHECKED' => $miniland_be_checked, 
'MINILAND_FR_CHECKED' => $miniland_fr_checked, 
'MINILAND_CA_CHECKED' => $miniland_ca_checked,  
'MINILAND_CH_CHECKED' => $miniland_ch_checked, 
'MINILAND_LU_CHECKED' => $miniland_lu_checked, 
		'VIEW_EMAIL_NO' => ( !$viewemail ) ? 'checked="checked"' : '',
		'HIDE_USER_YES' => ( !$allowviewonline ) ? 'checked="checked"' : '',
		'HIDE_USER_NO' => ( $allowviewonline ) ? 'checked="checked"' : '',
		//début allow_pm_arcade
		'PM_ARCADE_YES'=> ($pmarcade)? 'checked="checked"' : '',
		'PM_ARCADE_NO' => (!$pmarcade)? 'checked="checked"' : '',
//fin allow_pm_arcade
...
'L_MINILAND_BE' =>$lang['Be'], 
'L_MINILAND_FR' =>$lang['Fr'], 
'L_MINILAND_CA' =>$lang['Ca'],
'L_MINILAND_CH' =>$lang['Ch'],
'L_MINILAND_LU' =>$lang['Lu'],
'L_MINILAND_NOT_SPECIFY' =>$lang['No_miniland_specify'],
		// Start add - Mood MOD
		'L_MOOD' =>$lang['Mood'], 
		'L_MOOD_SAD' =>$lang['Sad'], 
		'L_MOOD_HAPPY' =>$lang['Happy'], 
		'L_MOOD_ANGRY' =>$lang['Angry'],
		'L_MOOD_COOL' =>$lang['Cool'],
		'L_MOOD_DEVIL' =>$lang['Devil'],
		'L_MOOD_ILL' =>$lang['Ill'],
		'L_MOOD_LOVE' =>$lang['Love'],
		'L_MOOD_SLEEP' =>$lang['Sleep'],
		'L_MOOD_SURPRISED' =>$lang['Surprised'],
		'L_MOOD_NOT_SPECIFY' =>$lang['No_mood_specify'],
		// End add - Mood MOD
// Start add - Gender MOD
...
//début allow_pm_arcade
		'L_ARCADE_OP'=> $lang['Arcade_op'],
		'L_PM_ARCADE' => $lang['Pm_arcade'],
		'L_PM_ARCADE_EXPLAIN' => $lang['Pm_arcade_explain'],
//fin allow_pm_arcade
