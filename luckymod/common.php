...
//-- mod : totally erc ---------------------------------------------------------
//-- add
include($phpbb_root_path . './includes/class_erc.'.$phpEx);
...
{
	message_die(GENERAL_MESSAGE, 'Veuillez supprimer le répétoire install');
}
...
{
    if ( $board_config['reason'] != "" )
	{
		message_die(GENERAL_MESSAGE, $board_config['reason'], 'Information');
	}
else
	{
