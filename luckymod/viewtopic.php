...
$sql = "SELECT u.username, u.user_allow_viewonline, u.user_session_time, u.user_id, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_sig, u.user_sig_bbcode_uid, u.user_avatar, u.user_avatar_type, u.user_allowavatar, u.user_allowsmile, u.user_birthday, u.user_next_birthday_greeting, u.user_gender, u.user_mood, u.user_miniland, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid, u.user_style, t.style_name
	FROM " . POSTS_TABLE . " p, " . THEMES_TABLE . " t, " . USERS_TABLE . " u, " . POSTS_TEXT_TABLE . " pt
...
for($i = 0; $i < $total_posts; $i++)
{
	...
	if ( $postrow[$i]['user_birthday'] != 999999 ) 
	{
		...
		$poster_age = '<b>' . $lang['Age'] . '</b>' . ': ' . $poster_age;
...
//
	...
	{ 
    	...
    	// MOD - TODAY AT - END
	$poster_posts = ( $postrow[$i]['user_id'] != ANONYMOUS ) ? '<b>' . $lang['Posts'] . '</b>'  . ': ' . $postrow[$i]['user_posts'] : '';
	...
	$poster_avatar = ( $board_config['allow_avatar_upload'] && ($postrow[$i]['user_session_time'] >= ( time() - 300 )) && ($postrow[$i]['user_allow_viewonline'])) ? '<img src="' . $board_config['avatar_path'] . '/' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfull" border="0" />' : '<img src="' . $board_config['avatar_path'] . '/' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfade" border="0" />' ;
	break;
	case USER_AVATAR_REMOTE:
	$poster_avatar = ( $board_config['allow_avatar_remote'] && ($postrow[$i]['user_session_time'] >= ( time() - 300 )) && ($postrow[$i]['user_allow_viewonline'])) ? '<img src="' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfull" border="0" />' : '<img src="' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfade" border="0" />';
	break;
	case USER_AVATAR_GALLERY:
	$poster_avatar = ( $board_config['allow_avatar_local'] && ($postrow[$i]['user_session_time'] >= ( time() - 300 )) && ($postrow[$i]['user_allow_viewonline'])) ? '<img src="' . $board_config['avatar_gallery_path'] . '/' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfull" border="0" />' : '<img src="' . $board_config['avatar_gallery_path'] . '/' . $postrow[$i]['user_avatar'] . '" alt="" class="imgfade" border="0" />';
	break;
		}
	}
...
switch ($postrow[$i]['user_miniland']) 
{ 
	case 1 : $miniland_image = $lang['Miniland'].": <img src=\"" . $images['icon_be'] . "\" alt=\"" . $lang['miniland'].  ":".$lang['Be']."\" title=\"" . $lang['Miniland'] . ":".$lang['Be']. "\" border=\"0\" />"; break; 
	case 2 : $miniland_image = $lang['Miniland'].": <img src=\"" . $images['icon_fr'] . "\" alt=\"" . $lang['miniland']. ":".$lang['Fr']. "\" title=\"" . $lang['Miniland'] . ":".$lang['Fr']. "\" border=\"0\" />"; break; 
	case 3 : $miniland_image = $lang['Miniland'].": <img src=\"" . $images['icon_ca'] . "\" alt=\"" . $lang['miniland'].  ":".$lang['Ca']."\" title=\"" . $lang['Miniland'] . ":".$lang['Ca']. "\" border=\"0\" />"; break; 
	case 4 : $miniland_image = $lang['Miniland'].": <img src=\"" . $images['icon_ch'] . "\" alt=\"" . $lang['miniland'].  ":".$lang['Ch']."\" title=\"" . $lang['Miniland'] . ":".$lang['Ch']. "\" border=\"0\" />"; break; 
	case 5 : $miniland_image = $lang['Miniland'].": <img src=\"" . $images['icon_lu'] . "\" alt=\"" . $lang['miniland']. ":".$lang['Lu']. "\" title=\"" . $lang['Miniland'] . ":".$lang['Lu']. "\" border=\"0\" />"; break; 
	 
	
        default : $miniland_image=""; 
}

// Start add - Mood MOD
		switch ($postrow[$i]['user_mood']) 
		{ 
			case 1 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_sad'] . "\" alt=\"" . $lang['mood'].  ":".$lang['Sad']."\" title=\"" . $lang['Mood'] . ":".$lang['Sad']. "\" border=\"0\" />"; break; 
			case 2 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_happy'] . "\" alt=\"" . $lang['mood']. ":".$lang['Happy']. "\" title=\"" . $lang['Mood'] . ":".$lang['Happy']. "\" border=\"0\" />"; break; 
			case 3 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_angry'] . "\" alt=\"" . $lang['mood'].  ":".$lang['Angry']."\" title=\"" . $lang['Mood'] . ":".$lang['Angry']. "\" border=\"0\" />"; break; 
			case 4 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_cool'] . "\" alt=\"" . $lang['mood']. ":".$lang['Cool']. "\" title=\"" . $lang['Mood'] . ":".$lang['Cool']. "\" border=\"0\" />"; break; 
			case 5 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_devil'] . "\" alt=\"" . $lang['mood'].  ":".$lang['Devil']."\" title=\"" . $lang['Mood'] . ":".$lang['Devil']. "\" border=\"0\" />"; break; 
			case 6 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_ill'] . "\" alt=\"" . $lang['mood']. ":".$lang['Ill']. "\" title=\"" . $lang['Mood'] . ":".$lang['Ill']. "\" border=\"0\" />"; break; 
			case 7 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_love'] . "\" alt=\"" . $lang['mood'].  ":".$lang['Love']."\" title=\"" . $lang['Mood'] . ":".$lang['Love']. "\" border=\"0\" />"; break; 
			case 8 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_sleep'] . "\" alt=\"" . $lang['mood']. ":".$lang['Sleep']. "\" title=\"" . $lang['Mood'] . ":".$lang['Sleep']. "\" border=\"0\" />"; break; 
			case 9 : $mood_image = $lang['Mood'].": <img src=\"" . $images['icon_surprised'] . "\" alt=\"" . $lang['mood'].  ":".$lang['Surprised']."\" title=\"" . $lang['Mood'] . ":".$lang['Surprised']. "\" border=\"0\" />"; break; 
...
$style_name = $postrow[$i]['style_name'];
	...
	$theme_num = sprintf($lang['Style_theme_num'], $style_counts[$postrow[$i]['user_style']]);
	$l_style = $lang['Style'];
...
/*-MOD
		'POSTER_NAME' => $poster,
MOD-*/
		'POSTER_NAME' => ( $poster_id == ANONYMOUS ) ? ( ( $postrow[$i]['post_username'] != '' ) ? $postrow[$i]['post_username'] : $lang['Guest'] ) : $erc->get_colors($postrow[$i], $postrow[$i]['username']),
//-- fin mod : totally erc -----------------------------------------------------
		// Start add - Birthday MOD
		...
		'POSTER_MINILAND' => $miniland_image,
		// Start add - Mood MOD
		'POSTER_MOOD' => $mood_image,
		// End add - Mood MOD
// Start add - Gender MOD
...
// Start add - Trophee
	...
	$sql = 	"SELECT game_id, game_pic, game_highuser, game_name, game_highscore
			FROM " .GAMES_TABLE. "
			WHERE game_highuser=".$poster_id."
			ORDER BY game_name ASC"; 
			
	if ( !($result = $db->sql_query($sql)) )
		{
			message_die(GENERAL_ERROR, 'Impossible d\'accéder à la table', '', __LINE__, __FILE__, $sql);
		}
	$number_win=mysql_num_rows($result);	
	if ($number_win)
	{	
		
			  $template->assign_block_vars('postrow.num', array(
			  'L_WINNER' => $lang['Winner'],
			  'NUM_WIN' => $number_win
			  ));
		...
		{ 
		  $template->assign_block_vars('postrow.trophee', array( 
			  'GAME_NAME' => $gamer['game_name'], 
			  'U_GAME' => append_sid("games.$phpEx?gid=".$gamer['game_id']),
			  'GAME_PIC'=> "<img src=games/pics/".$gamer['game_pic']." width=15 height=15 border=0>",
