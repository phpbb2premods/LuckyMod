  ...
  <table border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"border-collapse: collapse\" bordercolor=\"#111111\" width=\"300\" id=\"AutoNumber1\">
    ...
    <tr>
      <td bgcolor=\"#D4D0C8\"><font size=\"2\">Les restrictions suivantes s'appliquent:</font><ul type=\"square\">
        ...
        if (($extensions_wav == "") or ($extensions_wav == " ") or ($ext_count_wav == "0") or ($ext_count_wav == "") or ($limit_ext_wav != "yes") or ($limit_ext_wav == "")) {
           echo "";
        } else {
        $ext_count_wav2 = $ext_count_wav+1;
        for($counter=0; $counter<$ext_count_wav; $counter++) {
            echo "&nbsp; $extensions_wav[$counter]";
        }
        }
        if (($limit_size_wav == "") or ($size_limit_wav != "yes")) {
            $limit_size_wav = "any size";
        } else {
            $limit_size_wav .= " bytes";
        }
        echo"</b></font></li>
...
<button name=\"submit\" type=\"submit\" style=\"font-family: v; font-size: 10pt; color: #5E6A7B; border: 1px solid #5E6A7B; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1\"><b>envoyer</b></button>
    ...
    <tr>
      ...
      <a href=\"insert_wav.php\" style=\"text-decoration: none\"><font color=\"#FFFFFF\"><b>Fermer</b></font></a>
      </font></td>
    </tr>
  </table>
  </center>
...
if(file_exists("$absolute_path_wav/$file_name")) {
$endresult = "<font size=\"2\"><font color=\"#000000\">Le fichier existe déja</font>";
} else {
if (($size_limit_wav == "yes") && ($limit_size_wav < $file_size)) {
$endresult = "<font size=\"2\"><font color=\"#000000\">Le fichier est trop gros</font>";
} else {
$ext = strrchr($file_name,'.');
if (($limit_ext_wav == "yes") && (!in_array($ext,$extensions_wav))) {
$endresult = "<font size=\"2\">le fichier n'est pas un .swf</font>";
}else{
@copy($file, "$absolute_path_wav/$file_name") or $endresult = "<font size=\"2\">le fichier a été up-loader</font>";
}
}
}
}
