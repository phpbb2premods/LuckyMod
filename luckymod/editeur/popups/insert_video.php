...
<HTML id=video STYLE="width: 330px; height: 350px;">
<HEAD>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<TITLE>Insertion modules video real-player</TITLE>
<style>
...
function video_insert() {
	var text1="</embed>";
		var param="TYPE=\"audio/x-pn-realaudio-plugin\" console=\"Clip1\" controls=\"ImageWindow,PlayButton\" height=\"160\" width=\"200\" autostart=\"false\" ";
		var img = window.event.srcElement;
	if (img) {
		var src = img.src.replace(/^[a-z]*:[/][/][^/]*/, "");
			
		text2='<embed src=' + src +' '+ param +'>';
		text=text2+text1;
...
$folder='./media/video/';//repertoire à lister / folder to read
...
echo "<a href='$folder$tab[$i]'  target=\"visionner\">$image</a></td><td bgcolor=\"#0000FF\" width=10 align=\"center\"><img  onclick='video_insert()' src=\"$folder$tab[$i]\" width=\"10\" height=\"10\"></td><td bgcolor=\"\" width=60></td> ";
...
<form name="form1" method="post" action="upload_video.php" enctype="multipart/form-data">

    <input type="submit" name="Submit" value="Uploader un Fichier vidéo" class="bouton">
</form>
  </fieldset> 
