...
HTMLArea.Config = function () {
	 ...
	 */
	this.toolbar = [
		[  "separator", "preview",  "separator",  "htmlmode", "separator", "fontname", "space",
		  "fontsize", "space",
		  "formatblock", "space",
		...
		[ "imprimer", "separator", "justifyleft", "justifycenter", "justifyright", "justifyfull","separator",
		  "insertorderedlist", "insertunorderedlist", "outdent", "indent", "separator", "marquee", "specchar",  "separator", "today", "createlink",  "separator",
		  "forecolor", "hilitecolor", "separator", "textindicator", "separator",
		  "line", "insertimage", "flash", "video", "wav", "smileplus", "separator", "inserttable", "separator",
	...
	this.btnList = {
		bold: [ "Gras", "images/ed_format_bold.gif", false, function(e) {e.execCommand("bold");} ],
		italic: [ "Italique", "images/ed_format_italic.gif", false, function(e) {e.execCommand("italic");} ],
		...
		subscript: [ "Met le texte sélectionnné en exposant", "images/ed_format_sub.gif", false, function(e) {e.execCommand("subscript");} ],
		...
		insertorderedlist: [ "Insere une liste numerotee.", "images/ed_list_num.gif", false, function(e) {e.execCommand("insertorderedlist");} ],
		insertunorderedlist: [ "Insere une liste a puces", "images/ed_list_bullet.gif", false, function(e) {e.execCommand("insertunorderedlist");} ],
		...
		popupeditor: [ "Agrandir l'editeur", "images/fullscreen_maximize.gif", true, function(e) {e.execCommand("popupeditor");} ],
		about: [ "Version de cette editeur", "images/ed_about.gif", true, function(e) {e.execCommand("about");} ],
		showhelp: [ "Aide de cette editeur", "images/ed_help.gif", true, function(e) {e.execCommand("showhelp");} ],
		...
		cut: [ "Couper la selection selection", "images/ed_cut.gif", false, cut_copy_paste ],
		copy: [ "Copier la selection", "images/ed_copy.gif", false, cut_copy_paste ],
		paste: [ "Paste from clipboard", "images/ed_paste.gif", false, cut_copy_paste ],
		preview: [ "Previsualiser", "images/ed_preview.gif", false, function(e) {e.execCommand("preview");} ],
        		smileplus: [ "Inserer un smilies", "images/smilies.gif", false, function(e) {e.execCommand("smileplus");} ],
		today: [ "Inserer la date", "images/ed_today.gif", false, function(e) {e.execCommand("today");} ],
		marquee: [ "Inserer un text en croll (Marque)", "images/ed_marquee.gif", false, function(e) {e.execCommand("marquee");} ],  
		line: [ "Inserer une ligne de separation", "images/ed_line.gif", false, function(e) {e.execCommand("line");} ],
		imprimer: [ "imprimer", "images/ed_print.gif", false, function(e) {e.execCommand("imprimer");} ],
		specchar: [ "Inserer un caractere special", "images/ed_spec_char.gif", false, function(e) {e.execCommand("specchar");} ],
		flash: [ "Inserer un flash", "images/flash.gif", false, function(e) {e.execCommand("flash");} ],
		video: [ "Inserer une video", "images/ed_video.gif", false, function(e) {e.execCommand("video");} ],
		wav: [ "Inserer un fichier mp3_wav", "images/ed_mp3.gif", false, function(e) {e.execCommand("wav");} ]
 ...
 *  Category: date
 ***************************************************/
HTMLArea.prototype._today = function() {
 var editor = this;	// for nested functions
 var sel = this._getSelection();
 var today = editor._createRange(sel);
 var er = showModalDialog("popups/today.html","", "resizable: no; help: no; status: no; scroll: no; ");
 		if (!er) {return false;}
 var doc = editor._doc;
 today.pasteHTML(er);
};
 ...
 *  Category: preview 
 ***************************************************/
HTMLArea.prototype._preview = function() {

      if (!editor.getHTML()) {
          alert("Editeur vide !");
      return false;
       }
	win = window.open('','preview','toolbar=no,location=no,menubar=no,status=yes,scrollbars=yes,resizable=yes width=480,height=300,left=250,top=150');
 ...
 *  Category: marquee
****************************************************/
HTMLArea.prototype._marquee = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var marquee = editor._createRange(sel);
var er = showModalDialog("popups/insert_marquee.php","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
 var doc = editor._doc;
 marquee.pasteHTML(er);
 ...
 *  Category: line
****************************************************/
HTMLArea.prototype._line = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var line = editor._createRange(sel);
var er = showModalDialog("popups/insert_line.php","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
var doc = editor._doc;
line.pasteHTML(er);
};
 ...
 *  Category: specchar
****************************************************/
HTMLArea.prototype._specchar = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var specchar = editor._createRange(sel);
var er = showModalDialog("popups/insert_char.html","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
var doc = editor._doc;
specchar.pasteHTML(er);
};

/****************************************************
 *  Category: flash
****************************************************/
HTMLArea.prototype._flash = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var flash = editor._createRange(sel);
var er = showModalDialog("popups/insert_flash.html","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
var doc = editor._doc;
flash.pasteHTML(er);
};
 ...
 *  Category: video
****************************************************/
HTMLArea.prototype._video = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var video = editor._createRange(sel);
var er = showModalDialog("popups/insert_video.html","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
var doc = editor._doc;
video.pasteHTML(er);
};
 ...
 *  Category: audio
****************************************************/
HTMLArea.prototype._wav = function() {
var editor = this;	// for nested functions
var sel = this._getSelection();
var wav = editor._createRange(sel);
var er = showModalDialog("popups/insert_wav.html","","resizable: yes; help: no; status: no; scroll: no; ");
		if (!er) {return false;}
var doc = editor._doc;
wav.pasteHTML(er);
};
...
HTMLArea.prototype._imprimer = function() {
editor._doc.execCommand("Print");
}	;	

/***************************************************
 *  Category: insertImage
 ***************************************************/
 ...
 *  Category: Smileplus 
 ***************************************************/
HTMLArea.prototype._smileplus = function() {
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("../plugins/smilesPlus/insertsmile.php", function(param) {
			if (!param) {	// user must have pressed Cancel
			return false;
		}
		var sel = editor._getSelection();
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID.toLowerCase()) {
	    ...
	    case "forecolor":
		this._popupDialog("set_color.html", function(color) {
...
case "imprimer": this._imprimer(); break;
case "line": this._line(); break;
case "specchar": this._specchar(); break;
case "today": this._today(); break;
case "marquee": this._marquee(); break;
case "smileplus": this._smileplus(); break;
case "inserttable": this._insertTable(); break;
case "insertimage": this._insertImage(); break;
case "preview": this._preview(); break;
case "about"    : this._popupDialog("about.html", null, null); break;
case "showhelp" : window.open('reference.html','ha_help','toolbar=no,location=no,menubar=no,status=yes,scrollbars=yes,resizable=yes,width=340,height=480"'); break;
case "flash": this._flash(); break;
case "video": this._video(); break;
case "wav": this._wav(); break;
