...
$lang['Confirm_delete_smiley'] = 'Êtes-vous sûr de vouloir supprimer ce smilie ?';
...
$lang['user_today'] = 'Utilisteurs ayant visité le forum aujourd\'hui';
...
$lang['Hidde_last_logon'] = 'Cacher l\'heure de la dernière connexion';
$lang['Hidde_last_logon_expain'] = 'Si cette option est mise sur oui, l\'heure de la dernière connexion des utilisateurs, affichée dans leur profil, sera cachée aux autres utilisateurs à l\'exception du webmaster.';
// End add - Last Visit Mod
// Start add - Prune users MOD
$lang['Prune_users'] = 'Suppression des membres'; 
// End add - Prune users MOD
// DEBUT >> MOD zone de restriction
$lang['ZR_title'] = 'Gestion des restrictions de zones';
$lang['ZR_description'] = 'Donnez des restrictions à certaines zones de votre forum, choisissez si tous vos visiteurs auront accès par exemple à la FAQ où à la liste des membres. En choisissant un rang d\'autorisation vous posez une restriction sur les rangs précédents, par exemple en choisissant modérateur pour le champ profil, cela signifira que seul les modérateurs et administrateurs pourront lire les profils publics';
$lang['ZR_none'] = 'Aucune';
$lang['ZR_member'] = 'Membre';
$lang['ZR_modo'] = 'Modérateur';
$lang['ZR_admin'] = 'Administrateur';
$lang['ZR_submit'] = 'Ajouter les restrictions';
$lang['ZR_reset'] = 'Annuler les modifications';
// FIN >> MOD zone de restriction
//-- mod : totally erc ---------------------------------------------------------
//-- add
$lang['Ranks_whosonline'] = 'Extend Rank Color';
$lang['erc_settings'] = 'Gestion des couleurs de groupes';
$lang['erc_admincolor'] = 'Couleur du groupe des Administrateurs';
$lang['erc_modcolor'] = 'Couleur du groupe des Modérateurs';
$lang['erc_usercolor'] = 'Couleur du groupe des Membres';
//-- xs compliance
$lang['xs_data_erc_admincolor'] = 'Couleur du groupe des Administrateurs';
$lang['xs_data_erc_modcolor'] = 'Couleur du groupe des Modérateurs';
$lang['xs_data_erc_usercolor'] = 'Couleur du groupe des Membres';
$lang['xs_data_erc_admincolor_explain'] = '<em>(totally erc)</em>';
$lang['xs_data_erc_modcolor_explain'] = '<em>(totally erc)</em>';
$lang['xs_data_erc_usercolor_explain'] = '<em>(totally erc)</em>';
//-- fin mod : totally erc -----------------------------------------------------
// 
...
$lang['lottery_no_items'] = 'Il n\'y a aucun article dans la base de données de la Loterie !'; 
$lang['lottery_rand'] = 'Aléatoire'; 
$lang['lottery_statistics'] = 'Statistiques de la Loterie'; 
$lang['lottery_edit_settings'] = 'Éditez les options de la Loterie'; 
$lang['lottery_no_one'] = 'Personne'; 
$lang['lottery_editor'] = 'Éditeur de la Loterie'; 
$lang['lottery_index_explain'] = 'Cette section vous permet d\'éditer les options de la Loterie.'; 
$lang['lottery_no_item'] = 'Cet article n\'existe pas !'; 
$lang['lottery_invalid_action'] = 'Action invalide !'; 
$lang['lottery_click_to_return'] = 'Cliquez %sIci%s pour retourner aux option de la Loterie.'; 
$lang['lottery_random_items_updated'] = 'Les options des articles ont été mises à jour avec succès !'; 
$lang['lottery_item_added'] = 'L\'article supplémentaire a été ajouté avec succès !'; 
$lang['lottery_item_removed'] = 'L\'article a été enlevé avec succès !'; 
$lang['lottery_updated'] = 'La Loterie a été mise à jour avec succès !'; 
$lang['lottery_status'] = 'Statut de la Loterie'; 
$lang['lottery_add_item'] = 'Ajoutez un article'; 
$lang['lottery_add_items'] = 'Ajoutez un article à la base de données de la Loterie'; 
$lang['lottery_remove_item'] = 'Enlevez un article'; 
$lang['lottery_current_items'] = 'Article mis en jeu de la base de données de la Loterie'; 
$lang['lottery_update_settings'] = 'Mise à jour des options'; 
$lang['lottery_max_cost'] = 'Coût maximum des l\'article pris en compte'; 
$lang['lottery_min_cost'] = 'Coût minimum des l\'article pris en compte'; 
$lang['lottery_all_shops'] = 'Tous les magasins'; 
$lang['lottery_from_shop'] = 'Choix du/des magasin(s)'; 
$lang['lottery_update'] = 'Mise à jour'; 
$lang['lottery_currency'] = 'Devise à employer'; 
$lang['lottery_history'] = 'Historique de la Loterie'; 
$lang['lottery_item_pool'] = 'Base de donnée des articles de la Loterie'; 
$lang['lottery_full_display'] = 'Affichage en grand'; 
$lang['lottery_max'] = 'Maximum de billet(s) autorisé(s) pour chaque achat';
$lang['lottery_off'] = 'Off'; 
$lang['lottery_on'] = 'On'; 
$lang['lottery_mult_tickets'] = 'Posibilité d\'acheter plusieurs billets par achat';
$lang['lottery_multiple'] = 'Multiple'; 
$lang['lottery_single'] = 'Simple'; 
$lang['lottery_tickets_allowed'] = 'Détermine si plusieurs achats de billets sont possibles';
$lang['lottery_draw_periods'] = 'Durée de la Loterie'; 
$lang['lottery_entry_cost'] = 'Coût de participation à la Loterie'; 
$lang['lottery_base_amount'] = 'Valeur minimum de la Loterie'; 
$lang['lottery_name'] = 'Nom de la Loterie'; 
$lang['lottery_auto_restart'] = 'Relancement automatique'; 
$lang['lottery_last_won'] = 'Dernier gagnant'; 
$lang['lottery_pool'] = 'Base de donnée de la Loterie'; 
$lang['lottery_time_left'] = 'Le temps restant'; 
$lang['lottery_duration_left'] = 'Durée'; 
$lang['lottery_total_entries'] = 'Participants totals'; 
$lang['lottery_items_table'] = 'Éditez la base de données de la Loterie'; 
$lang['lottery_items_settings'] = 'Éditez les options des articles'; 

// Lottery Error Variables 
$lang['lottery_error_updating'] = 'Erreur lors de la mise à jour de la table %s !';
$lang['lottery_error_deleting'] = 'Erreur de suppression à partir de la table %s !'; 
$lang['lottery_error_selecting'] = 'Erreur pour trouver les informations de la table %s !'; 
$lang['lottery_error_inserting'] = 'Erreur pour insérer les informations dans la table %s !'; 
