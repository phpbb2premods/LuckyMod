...
$template->set_filenames(array( 
  	'portal_foot' => 'portal_foot_body.tpl') 
);

$sql_mod = "SELECT * FROM " . PORTAL_STRUCT . "  s LEFT JOIN " . PORTAL_MOD . " m on m.mod_id = s.mod_id WHERE s.page_id = $page_id AND s.struct_col IN (3, 4) ORDER BY s.struct_col ASC, s.struct_order ASC " ;
