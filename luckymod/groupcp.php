...
zone_de_restriction('Groupes', 'groupcp.' . $phpEx);
...
//-- add
					...
					{
						$erc->update_colors($row['user_id'], $group_name_row['group_color']);
					}
//-- fin mod : totally erc -----------------------------------------------------
...
//-- add
					// delete users color
					$erc->update_colors($sql_in, false, true);	
//-- fin mod : totally erc -----------------------------------------------------
...
MOD-*/
//-- add
		'GROUP_NAME' => ( !empty($group_info['group_color']) && !empty($board_config['allow_totally_erc']) ) ? '<span style="color:' . $id_color[$group_info['group_color']] . '">' . $group_info['group_name'] . '</span>' : $group_info['group_name'],
//-- fin mod : totally erc -----------------------------------------------------
...
MOD-*/
//-- add
		'MOD_USERNAME' => $erc->get_colors($group_moderator, $group_moderator['username']),
//-- fin mod : totally erc -----------------------------------------------------
		'MOD_FROM' => $from,
		'MOD_JOINED' => $joined,
		'MOD_POSTS' => $posts,
...
MOD-*/
//-- add
				'USERNAME' => $erc->get_colors($group_members[$i], $group_members[$i]['username']),
//-- fin mod : totally erc -----------------------------------------------------
				'FROM' => $from,
				'JOINED' => $joined,
				'POSTS' => $posts,
...
MOD-*/
//-- add
					'USERNAME' => $erc->get_colors($modgroup_pending_list[$i], $modgroup_pending_list[$i]['username']),
//-- fin mod : totally erc -----------------------------------------------------
					'FROM' => $from,
					'JOINED' => $joined,
					'POSTS' => $posts,
