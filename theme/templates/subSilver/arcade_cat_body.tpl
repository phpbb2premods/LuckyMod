...
<!-- BEGIN cat_row -->
	...
	<td>
	  ...
	  <tr>
	    <td class="cat" colspan="5"><span class="cattitle">{cat_row.CATTITLE}</span></td>
	  </tr>
<!-- BEGIN game_row -->
	  <tr>
...
<!-- END game_row -->
	  <tr>
	    <td class="row2" colspan="5" align="{cat_row.LINKCAT_ALIGN}"><span class="gensmall"><a href="{cat_row.U_ARCADE}">{cat_row.L_ARCADE}</a></span></td>
	  </tr>
	  </table>
	</TD>  
	</tr>
