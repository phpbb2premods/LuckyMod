  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  <td align="left"><span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> -> <a href="{S_CONFIG_ACTION}" class="nav">{L_NAME}</a> {LAST_LOCATION}
...
<!-- BEGIN switch_tickets_multi -->
	<tr>
	  <td class="row1" align="center" colspan="2"><input type="text" name="amount" size="5" maxlength="5" value="1" class="post" /> <input type="submit" name="buy_tickets" value="{I_BUY_TICKETS}" class="liteoption" /></td
	</tr>
